 ...
 */
public abstract class AbstractJsonApi extends AbstractApi {

  public AbstractJsonApi sandbox(Boolean sandbox) {
   ...
   * 如果一个都没有则报错
   */
  public AbstractJsonApi(ApiCredentialConfiguration[] apiCredentialConfiguration,
    ...
    apiRuntimeContext.setApiDeserializer(new JsonApiDeserializer<>());
